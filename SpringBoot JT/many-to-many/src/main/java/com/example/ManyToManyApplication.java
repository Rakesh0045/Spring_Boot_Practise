...
public class ManyToManyApplication {
	...
	CommandLineRunner commandLineRunner() {
		return args -> {
			...
			var student1 = Student.builder().studentId(1).studentName("Rakesh").studentEmail("r@gmail.com")
					.courses(List.of(course1, course2, course3)).build();
			var student2 = Student.builder().studentId(2).studentName("Sanoj").studentEmail("s@gmail.com")
					.courses(List.of(course3, course4, course5)).build();
			var student3 = Student.builder().studentId(3).studentName("Manoj").studentEmail("m@gmail.com")
					.courses(List.of(course2, course3, course4)).build();

			studentRepository.saveAll(List.of(student1, student2, student3));

			//FETCH STUDENTS ALONG WITH COURSES
